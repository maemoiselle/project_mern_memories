...
<div>
  <section>
    <Container maxWidth="lg">
      <Box  pt={2}>
        <Typography variant="body2" paragraph={true}>Home/Crafts by Skill</Typography>
      </Box>
      <Box pb={3} pt={2} textAlign="left">
        <Typography variant="h4" gutterBottom={true}>DIY Crafts to embrace your inner artist.</Typography>
      </Box>
      <Box pb={2} textAlign="left">
        <Typography variant="body1" gutterBottom={true} color="textSecondary"> Browse by skill level.</Typography>
      </Box>
      <Grid container>
        <Grid item xs={9}>
      ...
      <Box pt={2} textAlign="center">
        <Button href="#" color="primary">See More</Button>
      </Box>
    </Container>
  </section>
</div>
